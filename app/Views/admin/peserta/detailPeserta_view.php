                ...
                <div class="row no-gutters">
                    <div class="col">
                        <div class="card-body">
                            ...
                            <br>
                            <a href="/Admin_kelolaPeserta/edit/<?= $peserta['id_peserta']; ?>" class="btn btn-warning">Edit</a>
                            ...
                            <a href="/Admin_kelolaPeserta/">Kembali ke daftar peserta</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="/Admin_kelolaPeserta/<?= $peserta['id_peserta']; ?>" method="POST" class="d-inline">
                    <?= csrf_field(); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/Admin_kelolaPeserta/cuti_true/<?= $peserta['id_peserta']; ?>" class="btn btn-success">Yes</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="cutiFalseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-warning" type="button" data-dismiss="modal">Cancel</button>
                <a href="/Admin_kelolaPeserta/cuti_false/<?= $peserta['id_peserta']; ?>" class="btn btn-success">Yes</a>
            </div>
        </div>
    </div>
</div>
